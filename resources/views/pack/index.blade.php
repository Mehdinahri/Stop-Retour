            ...
            <tbody id="myTable">
              ...
              <tr>
                  ...
                  <td>
                    ...
                    <form role="form" action="{{ route('pack.destroy',['pack' => $pack]) }}" method="post" style="float: left;margin-right: 2%;" id='form{{$pack->id}}'>
                      @csrf
                      @method("DELETE")
                      <a class="btn btn-danger btn-sm text-light" onclick="deleteConfirmation({{ $pack->id }})"><i class="fas fa-trash-alt"></i> Supprimer</a>
                    </form>
                  </td>
              </tr>
              @endforeach
