    ...
    <div class="col-md-4 mt-2 m-auto">
        ...
        <div class="card card-widget widget-user">
          ...
          <div class="widget-user-image">
            <img class="img-circle elevation-2 prof" src="
                                @if($reclamation->user->profile_photo_path =='https://picsum.photos/200')
                                {{ $reclamation->user->profile_photo_path }}
                                @else
                                http://stop-retour.com/stopretour/public{{ $reclamation->user->profile_photo_path }}
                                @endif" alt="{{$reclamation->user->name}}" alt="User Avatar" >
          </div>
          <div class="card-footer">
            <div class="row">
