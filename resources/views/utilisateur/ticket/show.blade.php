    ...
    <div class="card card-widget">
      ...
      <div class="card-header">
        ...
        <div class="user-block" style="display: flex">
          ...
          <img class="img-ticket" src="@if(Auth::user()->profile_photo_path=='https://picsum.photos/200')
              ...
              <div class="row">
                ...
                <div class="col-md-3 col-lg-3 mb-3">
                  ...
                  <div class="text-center" style="width:100%; border-right: 1px solid black;">
                    ...
                    <img class="img-ticket" src="@if($reponse->user->profile_photo_path=='https://picsum.photos/200')

                      {{$reponse->user->profile_photo_path}}

                      @else

                      http://stop-retour.com/stopretour/public{{$reponse->user->profile_photo_path}}

                      @endif" alt="{{$reponse->user->name}}"><br>
